...
const Signup = () => {
  return (
        <div className="sm:col-start-4 sm:col-end-8 col-span-full p-2 sm:bg-blue-400 sm:shadow-lg sm:shadow-blue-500 rounded-lg w-full flex flex-col gap-5 items-center">
            <span 
