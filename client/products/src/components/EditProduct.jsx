    ...
    <div className="w-full col-span-full grid grid-cols-12">
        <div className=" flex flex-col gap-2 md:col-start-4 md:col-end-10 sm:col-start-2 sm:col-end-12 col-span-full p-2">
            ...
            <label className="w-full flex flex-col">
                ...
                {
                    product.image && (
                        <img src={typeof product.image === "string" && product.image?.includes('base64') ?  product.image : URL.createObjectURL(product.image)} className="sm:w-20 sm:h-20 w-full m-2 h-auto"  />
                    )
                }
            </label>
